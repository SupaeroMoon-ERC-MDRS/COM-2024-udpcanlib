...
void vector_test(){
    ...
    std::vector<uint8_t> asige_dec = std::any_cast<std::vector<uint8_t>>(out[0].second["AsigE"]);
    std::vector<int32_t> asigf_dec = std::any_cast<std::vector<int32_t>>(out[0].second["AsigF"]);
    uint8_t bsiga_dec = std::any_cast<uint8_t>(out[0].second["BsigA"]);
    uint8_t bsigb_dec = std::any_cast<uint8_t>(out[0].second["BsigB"]);
    uint8_t bsigc_dec = std::any_cast<uint8_t>(out[0].second["BsigC"]);
